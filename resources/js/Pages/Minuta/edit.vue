...
export default {
  ...
  data () {
    return {
      form: {
        distrito: this.minutum.distrito,
        actualizado_por: this.user.id,
        responsable: this.minutum.responsable,
        supervisor: this.minutum.supervisor,
        participantes: this.minutum.participantes,
        fecha_analisis: this.minutum.fecha_analisis,
        fecha_inicio: this.minutum.fecha_inicio,
        fecha_final: this.minutum.fecha_final,
        observaciones: this.minutum.observaciones,
      }
    }
  },
  ...
  methods: {
    submit () {
        this.$inertia.put(this.route('minuta.update', this.minutum.id), this.form)
    },
  }
...
<AppLayout title="Dashboard">
    ...
    <div v-if="user.role !== 'Visitante'" class="py-12">
                ...
                <FormSection @submitted="submit">
                    ...
                    <template #form>
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            <InputLabel for="fecha_analisis" value="Fecha analisis" />
                            <TextInput
                            ...
                            />
                            <InputError :message="errors.fecha_analisis" class="mt-2" />
                        </div>

                        <div class="col-span-6 sm:col-span-4">
                            <InputLabel for="distrito" value="Distrito" />
                            <TextInput
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            <InputLabel for="participanetes" value="observaciones" />
                            <TextInput
                                ...
                                class="mt-1 block w-full"
                            />
                            <InputError :message="errors.observaciones" class="mt-2" />
                        </div>
