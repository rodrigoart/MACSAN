...
export default {
  ...
  methods: {
    submit () {
        this.$inertia.post(this.route('minuta.store'), this.form)
    },
  }
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
                ...
                <FormSection @submitted="submit">
                    ...
                    <template #title>
                        Creacion de nueva hoja de minuta
                    </template>

                    <template #description>
                        Una vez creada podras agregar problemas a solucionar e informacion adicional
                    </template>
