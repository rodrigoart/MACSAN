                        ...
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('dashboard')">
                                    ...
                                    <img :src="'/img/macsan_logo.png'"  alt="macsan_logo" class="m-auto" width="50">
                                </Link>
                            </div>
                            ...
                            <div v-if="$page.props.user.role !== 'Visitante'"  class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink  :href="route('usuario.index')" :active="route().current('usuario.*')">
                                    Usuarios
                                </NavLink>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink  :href="route('hoja-monitoreo.index')"
                                          :active="route().current('hoja-monitoreo.*')">
                                    Hojas de Monitoreo
                                </NavLink>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink  :href="route('minuta.index')" :active="route().current('minuta.*')">
                                    Minutas
                                </NavLink>
                            </div>
                        </div>
